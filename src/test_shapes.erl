...
test() ->
  ...
  try shapes:trianglesArea({shapes, [Circle2, Triangle_ill, Square1]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code1")
  catch
  ...
  try F1({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code2")
  catch
  ...
  try F2({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code3")
  catch
  ...
  try F3({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code4")
  catch
  ...
  try F4({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code5")
  catch
  ...
  try F5({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code6")
  catch
  ...
  try F6({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code7")
  catch
  ...
  try F7({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code8")
  catch
  ...
  try F8({shapes, [Square1, Ellipse_ill]}) of
    _ -> erlang:display("expected error not thrown!!! Problem in your code9")
  catch
